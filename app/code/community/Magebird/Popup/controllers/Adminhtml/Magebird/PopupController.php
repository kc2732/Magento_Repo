...
{  
  ...
  public function clearcacheAction(){
    ...
    public function mousetrackingAction()
    {
			$this->loadLayout();
			$this->_setActiveMenu('popup/items');
			...
			$this->_addContent($this->getLayout()->createBlock('magebird_popup/adminhtml_popup_mousetracking'));

			$this->renderLayout();
      /*    
  		$this->_initAction();   			
      $block = $this->getLayout()->createBlock('magebird_popup/adminhtml_mousetracking')->setTemplate('magebird/popup/mousetracking.phtml');          
      $this->getResponse()->setBody($block->toHtml());
      */
    }                 
} 